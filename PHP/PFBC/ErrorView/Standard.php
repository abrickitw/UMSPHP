...
class ErrorView_Standard extends ErrorView {
    public function applyAjaxErrorResponse() {
        ...
        if(errorSize == 1)
            ...
            var errorFormat = "Broj greški: " + errorSize  ;

        $('.alert-danger').hide();
        var errorHTML = '<div class="alert alert-danger"><a class="close" data-dismiss="alert" href="#">×</a><strong class="alert-heading"> errorFormat</strong><ul>';
